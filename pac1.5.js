window.Modernizr = function (i, e, I) {
    ...
    var j = {},
        ...
        F = {}.hasOwnProperty,
        O;
    O = typeof F !== "undefined" && typeof F.call !== "undefined" ? function (a, b) {
        return F.call(a, b)
    } : function (a, b) {
    ...
    (function () {
        ...
        function h(f, k) {
            for (var l = new RegExp("\\b(" + w + ")\\b(?!.*[;}])", "gi"), q = function (B) {
                return ".iepp_" + B
            }, x = -1; ++x < f.length;) k = f[x].media || k, h(f[x].imports, k), c(k, f[x].cssText.replace(l, q))
        }
        var t = a.style,
            g = b.getElementsByTagName("head")[0],
            o = {},
            w = "abbr article aside audio canvas details figcaption figure footer header hgroup mark meter nav output progress section summary time video",
            A = "createElement",
            G = "lastChild";
        h(b[A]("link"), "");
        h(b[A]("style"), "");
        t.overflow = "visible";
        a.attachEvent("onpropertychange", function () {
